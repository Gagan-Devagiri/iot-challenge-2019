#note this code is inherited from https://www.thingforward.io/techblog/2018-08-15-hacking-on-a-pytrack-gps-module.html
...
def check_for_valid_coordinates(gps):
    ...
    '''
    print(gps.satellite_data_updated())
